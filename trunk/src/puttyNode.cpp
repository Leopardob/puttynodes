...
#include "../include/puttyNode.h"


/*************************************************************/

MTypeId puttyNode::id( puttyNode_NODE_ID );

     
MObject puttyNode::aScript;   // the script to source
MObject puttyNode::aCmdBaseName;  // the base name of the command to execute
MObject puttyNode::aSource;           
MObject puttyNode::aNodeReady; 
MObject puttyNode::aScriptSourced;
MObject puttyNode::aDynDirty; 
...
/*************************************************************************************/
void* puttyNode::creator() 
{ 
	return new puttyNode(); 
}
